...
TARGET_PROJECT_DIR="$(normalize_path 'subprojects/laplacian.template.metamodel.document')"
...
checkout_from_code_repository() {
  ...
  then
    ...
    git clone \
        https://github.com/nabla-squared/laplacian.template.metamodel.document.git \
        $TARGET_PROJECT_DIR
  fi
