...
TARGET_PROJECT_DIR="$PROJECT_BASE_DIR/subprojects/domain-model-project-template"
...
sync_source_with_repository() {
  ...
  then
    ...
    git clone -b master \
        https://github.com/laplacian-core/domain-model.project-template.git \
        $TARGET_PROJECT_DIR
  else
...
project:
  ...
  source_repository:
    url: https://github.com/laplacian-core/domain-model.project-template.git
    branch: master
  module_repositories:
    local:
      ../../../mvn-repo
...
show_usage () {
cat << 'END'
Usage: ./scripts/generate-domain-model-project-template.sh [OPTION]...
  -h, --help
